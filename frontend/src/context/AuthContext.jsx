...
export const AuthProvider = ({ children }) => {
    ...
    const checkAuth = async () => {
        try {
            const response = await axios.get(
                "https://helpstir.in/csr/auth/verifytoken",
    ...
    const login = async (phone) => {
        try {
            const response = await axios.post(
                'https://helpstir.in/csr/auth/login',
                { phone },
                { withCredentials: true }
            );
    ...
    const loginOTPVerification = async (userId, otp) => {
      try {
        ...
        const response = await axios.post('https://helpstir.in/csr/auth/verify-login-otp', { user_id: userId, otp }, { withCredentials: true });
    ...
    const logout = async () => {
        try {
            const response = await axios.post('https://helpstir.in/csr/auth/logout', {}, { withCredentials: true });
